...
func (ec *executionContext) resolveEntity(
	...
	case "CategoricalCategoryCharacteristic":
		resolverName, err := entityResolverNameForCategoricalCategoryCharacteristic(ctx, rep)
		if err != nil {
			return nil, fmt.Errorf(`finding resolver for Entity "CategoricalCategoryCharacteristic": %w`, err)
		}
		switch resolverName {
		...
		case "findCategoricalCategoryCharacteristicByID":
			...
			if err != nil {
				return nil, fmt.Errorf(`unmarshalling param 0 for findCategoricalCategoryCharacteristicByID(): %w`, err)
			}
			entity, err := ec.Resolvers.Entity().FindCategoricalCategoryCharacteristicByID(ctx, id0)
			if err != nil {
				return nil, fmt.Errorf(`resolving Entity "CategoricalCategoryCharacteristic": %w`, err)
			}
	...
	case "NumericalCategoryCharacteristic":
		resolverName, err := entityResolverNameForNumericalCategoryCharacteristic(ctx, rep)
		if err != nil {
			return nil, fmt.Errorf(`finding resolver for Entity "NumericalCategoryCharacteristic": %w`, err)
		}
		switch resolverName {
		...
		case "findNumericalCategoryCharacteristicByID":
			id0, err := ec.unmarshalNUUID2githubᚗcomᚋgoogleᚋuuidᚐUUID(ctx, rep["id"])
			if err != nil {
				return nil, fmt.Errorf(`unmarshalling param 0 for findNumericalCategoryCharacteristicByID(): %w`, err)
			}
			entity, err := ec.Resolvers.Entity().FindNumericalCategoryCharacteristicByID(ctx, id0)
			if err != nil {
				return nil, fmt.Errorf(`resolving Entity "NumericalCategoryCharacteristic": %w`, err)
			}
	...
	case "ProductVariantVersion":
		resolverName, err := entityResolverNameForProductVariantVersion(ctx, rep)
		if err != nil {
			return nil, fmt.Errorf(`finding resolver for Entity "ProductVariantVersion": %w`, err)
		}
		switch resolverName {
		...
		case "findProductVariantVersionByID":
			id0, err := ec.unmarshalNUUID2githubᚗcomᚋgoogleᚋuuidᚐUUID(ctx, rep["id"])
			if err != nil {
				return nil, fmt.Errorf(`unmarshalling param 0 for findProductVariantVersionByID(): %w`, err)
			}
			entity, err := ec.Resolvers.Entity().FindProductVariantVersionByID(ctx, id0)
			if err != nil {
				return nil, fmt.Errorf(`resolving Entity "ProductVariantVersion": %w`, err)
			}
...
func entityResolverNameForCategoricalCategoryCharacteristic(ctx context.Context, rep EntityRepresentation) (string, error) {
	...
	for {
		...
		if !ok {
			entityResolverErrs = append(entityResolverErrs,
				fmt.Errorf("%w due to missing Key Field \"id\" for CategoricalCategoryCharacteristic", ErrTypeNotFound))
			break
		}
		if allNull {
			allNull = val == nil
		...
		if allNull {
			entityResolverErrs = append(entityResolverErrs,
				fmt.Errorf("%w due to all null value KeyFields for CategoricalCategoryCharacteristic", ErrTypeNotFound))
			break
		}
		return "findCategoricalCategoryCharacteristicByID", nil
	}
	return "", fmt.Errorf("%w for CategoricalCategoryCharacteristic due to %v", ErrTypeNotFound,
...
func entityResolverNameForNumericalCategoryCharacteristic(ctx context.Context, rep EntityRepresentation) (string, error) {
	// we collect errors because a later entity resolver may work fine
	// when an entity has multiple keys
	entityResolverErrs := []error{}
	for {
		...
		if !ok {
			entityResolverErrs = append(entityResolverErrs,
				fmt.Errorf("%w due to missing Key Field \"id\" for NumericalCategoryCharacteristic", ErrTypeNotFound))
			break
		}
		if allNull {
			allNull = val == nil
		...
		if allNull {
			entityResolverErrs = append(entityResolverErrs,
				fmt.Errorf("%w due to all null value KeyFields for NumericalCategoryCharacteristic", ErrTypeNotFound))
			break
		}
		return "findNumericalCategoryCharacteristicByID", nil
	}
	return "", fmt.Errorf("%w for NumericalCategoryCharacteristic due to %v", ErrTypeNotFound,
		errors.Join(entityResolverErrs...).Error())
}
...
func entityResolverNameForProductVariantVersion(ctx context.Context, rep EntityRepresentation) (string, error) {
	// we collect errors because a later entity resolver may work fine
	// when an entity has multiple keys
	entityResolverErrs := []error{}
	for {
		...
		if !ok {
			entityResolverErrs = append(entityResolverErrs,
				fmt.Errorf("%w due to missing Key Field \"id\" for ProductVariantVersion", ErrTypeNotFound))
			break
		}
		if allNull {
			allNull = val == nil
		...
		if allNull {
			entityResolverErrs = append(entityResolverErrs,
				fmt.Errorf("%w due to all null value KeyFields for ProductVariantVersion", ErrTypeNotFound))
			break
		}
		return "findProductVariantVersionByID", nil
	}
	return "", fmt.Errorf("%w for ProductVariantVersion due to %v", ErrTypeNotFound,
		errors.Join(entityResolverErrs...).Error())
}
