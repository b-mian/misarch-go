...
// order fields that carry a secondary `id` tiebreaker (NAME, VERSION,
// CREATED_AT) as well as the single-column ID ordering.
type page struct {
	table     string   // physical (lowercase) table name
	columns   string   // projection, e.g. "id, name, description, currentversionid"
